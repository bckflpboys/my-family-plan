...
import { Search, Filter, X, Globe, Music } from 'lucide-react';
...
export type FilterType = 'subscription' | 'country';
...
export function SearchBar({ value, onChange, onFilterChange, onCountryFilterChange, placeholder = 'Search families...' }: SearchBarProps) {
  ...
  const totalFilterCount = selectedSubscriptions.length + selectedCountries.length;
  ...
  return (
    <div className="w-full mx-auto space-y-3">
        ...
        <div id="filter-panel" className="bg-white rounded-xl shadow-md p-4 max-w-md mx-auto">
          ...
          <div className="flex justify-between items-center mb-3">
            <h3 className="text-sm font-medium text-gray-900">
              {activeFilterType === 'subscription' ? 'Filter by subscription' : 'Filter by country'}
            </h3>
      ...
      {!isFilterOpen && (selectedSubscriptions.length > 0 || selectedCountries.length > 0) && (
